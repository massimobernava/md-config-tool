...
{
    /// <summary>
    /// WaveStream that converts 24 bit audio back down to 16 bit, clipping if necessary
    /// </summary>
    public class Wave24To16Stream : WaveStream
    {
        ...
        public Wave24To16Stream(WaveStream sourceStream)
        {
            if (sourceStream.WaveFormat.Encoding != WaveFormatEncoding.IeeeFloat)
                throw new ApplicationException("Only 24 bit Floating point supported");
        ...
        public override int Read(byte[] destBuffer, int offset, int numBytes)
        {
            ...
            Convert24To16(destBuffer, offset, sourceBuffer, bytesRead);
        ...
        /// </summary>
        private unsafe void Convert24To16(byte[] destBuffer, int offset, byte[] sourceBuffer, int bytesRead)
        {
