...
namespace NAudio.Wave
{
    ...
    /// </summary>
    public class WaveChannel16To32 : AudioEffectWaveStream, ISampleNotifier
    {
        ...
        /// <summary>
        /// Creates a new WaveChannel16To32
        /// </summary>
        /// <param name="sourceStream">the source stream</param>
        /// <param name="volume">stream volume (1 is 0dB)</param>
        /// <param name="pan">pan control (-1 to 1)</param>
        public WaveChannel16To32(WaveStream sourceStream, float volume, float pan)
        {
            PadWithZeroes = true;
        ...
        /// <summary>
        /// Creates a WaveChannel16To32 with default settings
        /// </summary>
        /// <param name="sourceStream">The source stream</param>
        public WaveChannel16To32(WaveStream sourceStream)
            :
